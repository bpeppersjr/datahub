...
for(const mode of ['success','tamper','mixed-encoding','parallel','busy','busy-cancel','invalid','enrollment-drift','http-failure','invalid-utf8','cancel-transfer','cancel-after-commit','late-failure','checkpoint-tamper','failed-cohort-tamper'])test(`MN app lifecycle: ${mode}`,async t=>{
