...
async function loadDependencies(resolutionPointer, registryPointer) {
  ...
  if (registry.manifest.status !== "published-partial" || !["1.2.0", "1.3.0", "1.4.0", "1.5.0", "1.6.0"].includes(registry.manifest.publisher?.version)
    || registry.manifest.complete_national_business_registry !== false) {
    throw new Error("A verified partial National Business Registry 1.2.0 through 1.6.0 release is required.");
  }
