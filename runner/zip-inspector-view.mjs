...
export function createZipInspectorView({ businessCoverageViews, businessMap, zipQualityView, pharmacyCoverage = null, snapRetailerCoverage = null, fmcsaRegistrantCoverage = null, fdicBankfindCoverage = null, ncuaCreditUnionCoverage = null, fsisActiveEstablishmentCoverage = null, epaEchoActiveFacilityCoverage = null, irsEoBmfOrganizationCoverage = null, cmsNppesOrganizationPracticeLocationCoverage = null }) {
  return async function zipInspectorView({ zip, categoryId = "all", signal } = {}) {
    ...
    if (fmcsaRegistrantEvidence !== null && (typeof fmcsaRegistrantEvidence !== "object" || Array.isArray(fmcsaRegistrantEvidence))) {
      throw new Error("FMCSA registrant ZIP evidence loader returned an invalid aggregate.");
    }
    if (fmcsaRegistrantEvidence !== null && fmcsaRegistrantEvidence.zip_code !== zip) {
      throw new Error("FMCSA registrant ZIP evidence does not match the requested ZIP5.");
    }
    if (fdicBankfindEvidence !== null && (typeof fdicBankfindEvidence !== "object" || Array.isArray(fdicBankfindEvidence))) {
      throw new Error("FDIC BankFind ZIP evidence loader returned an invalid aggregate.");
    }
    if (fdicBankfindEvidence !== null && fdicBankfindEvidence.zip_code !== zip) {
      throw new Error("FDIC BankFind ZIP evidence does not match the requested ZIP5.");
    }
    if (ncuaCreditUnionEvidence !== null && (typeof ncuaCreditUnionEvidence !== "object" || Array.isArray(ncuaCreditUnionEvidence))) {
      throw new Error("NCUA credit-union ZIP evidence loader returned an invalid aggregate.");
    }
    ...
    if (irsEoBmfOrganizationEvidence !== null && (typeof irsEoBmfOrganizationEvidence !== "object" || Array.isArray(irsEoBmfOrganizationEvidence))) {
      throw new Error("IRS EO BMF organization ZIP evidence loader returned an invalid aggregate.");
    }
