...
function fixture(request, initialProps = {}) {
  ...
  runInNewContext(`${code}\nexports.TestNames = BusinessNames; exports.TestSummary = EntitySummary;`, {
    ...
    require: name => name === './credential-heatmap' ? { default: function CredentialHeatmap() {} } : name === './census-zbp-industry-heatmap' ? { default: function CensusZbpIndustryHeatmap() {} } : name === './census-nonemployer-county-heatmap' ? { default: function CensusNonemployerCountyHeatmap() {} } : name === './overture-heatmap-readiness' ? { default: function OvertureHeatmapReadiness() {} } : name === './nppes-pharmacy-heatmap' ? { default: function NppesPharmacyHeatmap() {} } : name === './organization-zip-evidence-panel' ? { default: function OrganizationZipEvidencePanel() {} } : name === './dataset-representation' ? { default: function DatasetRepresentation() {} } : name === './retained-county-panel' ? { default: function RetainedCountyPanel() {} } : name === './retained-childcare-panel' ? { default: function RetainedChildcarePanel() {} } : name === './runner-client' ? { runnerJson: request } : name === 'react' ? {
