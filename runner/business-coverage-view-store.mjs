...
function stateApiRow(row, sourceRevalidation = null, sourceRevalidationDocument = null, currentCoverageReleaseId = null) {
  ...
  const latestSourceAssessment = sourceRevalidation ? {
    ...
    authorized_next_action_type: sourceRevalidation.authorized_next_action_type,
    ...
    offline_fixture_connector_authorized: sourceRevalidation.offline_fixture_connector_authorized,
