...
export default function CmsHospitalAdoption({operations,disabled,onInspect}:{operations:Operation[];disabled:boolean;onInspect:()=>void}){
  ...
  return <section className="operations-builder" aria-labelledby="cms-retained-title">
    ...
    {summary&&<div>
      <p><strong>{summary.directoryRows.toLocaleString()} dated hospital directory rows</strong> · {summary.statesDcRows.toLocaleString()} rows in states/DC · {summary.territoryRows.toLocaleString()} territory rows · {summary.unknownStateRows.toLocaleString()} other/unresolved rows</p>
