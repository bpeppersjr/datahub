...
function parseArguments(args) {
  ...
  for (let index = 0; index < args.length; index += 1) {
    ...
    if (["--output", "--snap", "--nppes", "--fdic", "--ncua", "--fsis", "--echo", "--fmcsa", "--irs-eo", "--ct-business", "--co-business", "--or-business", "--ia-business", "--ny-business", "--fl-business", "--usps-zips"].includes(argument)) {
