...
- Local immutable plan: `data/reconciliations/production-plans/production-cms-directories-20260922-12.json`
- Exact confirmation SHA-256: `d7f6660ee8694035b11ebca177d025616aa64e8d3053745b1990bd1dd1214d45`
...
```powershell
npm run reconciliation:production:preflight -- --run-id production-cms-directories-20260922-12 --expected-plan-sha256 d7f6660ee8694035b11ebca177d025616aa64e8d3053745b1990bd1dd1214d45
```
