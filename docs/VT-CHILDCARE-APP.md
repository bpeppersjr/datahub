...
Follow-on implementation: [local publisher-cohort reporting](VT-CHILDCARE-REPORTING.md) now consumes the retained chain through a pinned enrollment and separate VT ledger field. This implements the local reporting boundary reviewed above, not national production integration or inferred address geography.
