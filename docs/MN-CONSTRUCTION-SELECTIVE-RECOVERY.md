...
September 8 follow-up: an independent read-only review of the retained registration receipts confirmed the exact-version hold still matches the later closing-quote diagnostic. The earlier `aa5ef9b0-4684-4496-b5ae-501c49a7e4e3` failure retained 11,751 contiguous partial frames (8,145 accepted dispositions and 3,606 rejections), not a complete acquisition. Buffered parsing/writing means this prefix cannot locate the malformed source boundary, and the offending raw bytes were not retained. No safe parser correction can be inferred from that evidence. Preserve the hold and successful residential release; next recovery requires a verified publisher correction or sufficiently bounded evidence of the actual malformed CSV boundary, not another encoding guess or replay of partial frames as acquired records. This review made no provider request or retry and changed no runtime hold.
