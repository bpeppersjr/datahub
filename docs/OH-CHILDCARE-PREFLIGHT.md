...
- The [offline normalization and four-artifact release stage](OH-CHILDCARE-RELEASE.md) is now implemented and tested. It supplies retained-source processing and immutable replay, but not live HTTP acquisition, current source-use authorization or app enrollment. Historical implementation notes above describe the earlier prerequisite boundary.
