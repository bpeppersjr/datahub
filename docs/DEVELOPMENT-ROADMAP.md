...
Coverage-view evidence: verified release `national-business-coverage-views-20260830-230901771Z-d285346e` pins the registry, geography, ZCTA jurisdiction overlay, resolution, benchmark, and Census Nonemployer manifests. It publishes three national scopes, 56 state views, 3,235 county views, 43,586 ZIP views, nine source views, and 18,852 first-class gap rows. All 6,161,280 location profiles were assessed; 336,573 coordinate-bearing profiles received one county assignment, while missing, unmatched, ambiguous, and conflicting geography remains explicit. ZIP/ZCTA topology reconciles exactly to 33,791 ZCTAs, and polygon-area weights are never used as business-location weights. The release remains partial, source-preserving, non-deduplicated, and local-aggregate-only.
