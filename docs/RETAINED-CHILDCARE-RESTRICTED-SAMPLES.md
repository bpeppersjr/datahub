...
The state-access ledger now admits the New Hampshire group as `unsupported-evidence-not-measured`, after verifying the installed snapshot and replaying its pinned normalization offline. The cell reports six retained rows and query ZIP `03755` only. It remains neither direct-state nor national evidence; statewide completeness is unknown, and no unique-business, physical-site, current-operation, active-business, identity-matching or public-export claim is made. Missing, malformed, tampered or non-NH sample evidence fails closed and cannot leak into another jurisdiction.
