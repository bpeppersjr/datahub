...
[Queue 4, wave 1](STATE-BUSINESS-SOURCE-DISCOVERY-QUEUE-4-2026-09-03.md) records the next ranked Idaho, New Mexico, Maine, and Wyoming decisions in a machine-checkable artifact. No candidate is autonomously acquirable: all nine shared production gates remain open. Maine and Wyoming additionally require an explicitly authorized purchase after their data contracts and derived-use rights are verified. The remaining Queue 4 discovery scope is New Hampshire, Montana, Rhode Island, South Dakota, Vermont, West Virginia, North Dakota, Alaska, and the District of Columbia; Alaska and D.C. already have statewide scoped evidence but not a broad organization layer.
