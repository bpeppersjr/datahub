...
The independently verified release `ca-abc-active-licenses-20260907-134420041Z-1d86412e` is bound to source release `ca-abc-active-licenses-2026-09-07-4adb619cd534904b`, official `Last-Modified` instant `2026-09-07T10:50:28.000Z`, and archive SHA-256 `38ce8f3b4d4876bb7e40a1475f64cb8dee1850f3bbf5312ac5bcf8d5088ec213`.

It counts all 129,142 source rows and selects 105,672 rows marked both `ACTIVE` and `LIC`. Those rows produce 84,497 organization/premise/establishment groups with 105,435 retained license activities across 2,920 source ZIP codes. The connector quarantines 237 rows in 215 invalid groups and preserves 3,155 selected activities whose reported expiration predates source observation. The 22 verified artifacts total 63,604,514 bytes. The release is complete only for its declared source selection and remains local-review-only at record level. It does not supply point coordinates or geometry, does not merge ZIP5 with the separate ZIP+4 field, and does not qualify as a broad California business denominator.
