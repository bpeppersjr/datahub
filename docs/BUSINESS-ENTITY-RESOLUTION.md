...
Compatibility now extends through registry publisher 2.11.0. Publisher 2.10.0 adds the mandatory split ZIP5/ZIP4 address contract, while 2.11.0 adds optional Illinois organization-only evidence without changing entity-resolution match-key semantics.
