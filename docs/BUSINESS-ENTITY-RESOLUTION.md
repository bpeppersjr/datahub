...
The independently verified release `business-entity-resolution-20260901-130709191Z-9ac403ad` depends on registry release `national-business-registry-20260901-105332522Z-b307e896`. Across 7,848,222 profiles and 6,436,937 usable address groups, it publishes 2,263,767 reversible site-alias decisions, 125,770 reversible establishment-alias decisions, and 86,916 unapplied review candidates in 100 decision partitions plus one aggregate summary. Two oversized residual review groups were skipped and counted; no automatic decision was created for them. The 101 verified artifacts total 393,588,654 bytes. Alaska, NYC DCWP, Chicago, Texas, and Los Angeles profiles remain local-review-only; Delaware and the other organization-only state layers create no location profiles.
