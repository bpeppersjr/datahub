...
The independently verified release `business-entity-resolution-20260901-091336354Z-3bc0423c` depends on registry release `national-business-registry-20260901-070150033Z-cb73e5fd`. Across 7,753,736 profiles and 6,370,804 usable address groups, it publishes 2,220,276 reversible site-alias decisions, 121,036 reversible establishment-alias decisions, and 84,894 unapplied review candidates in 100 decision partitions plus one aggregate summary. Two oversized residual review groups were skipped and counted; no automatic decision was created for them. The 101 verified artifacts total 385,212,592 bytes. NYC DCWP, Chicago, Texas, and Los Angeles profiles remain local-review-only; Delaware and the other organization-only state layers create no location profiles.
