...
The coverage publisher 2.6.0 release is aligned to national registry 2.9.0, its independently verified entity-resolution release, and the current deterministic benchmark sample. It adds New York retail-food-license organization, conditional premise, ZIP, and conservative platform-geocode evidence.

Release `national-business-coverage-views-20260902-080801627Z-c56ecd90` publishes seven independently verified artifacts totaling 565,430,324 bytes. It contains three national scopes, all 56 state equivalents, all 3,235 county equivalents, all 48,217 registry ZIP rows, 26 source views, and 28,128 explicit gap rows.
