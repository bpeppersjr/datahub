...
Release `national-business-coverage-views-20260831-233358059Z-51d9fdeb` publishes seven independently verified artifacts totaling 400,836,291 bytes. It contains three national scopes, all 56 state equivalents, all 3,235 county equivalents, all 48,142 registry ZIP rows, 17 source views, and 27,940 explicit gap rows.

The publisher assessed all 6,794,612 source-preserving location profiles. Source-reported address states match a supported Census state equivalent for 6,794,221 profiles; 391 remain missing or unsupported. Exactly 903,543 profiles carry valid points, 863,370 have one county assignment, 40,166 fall outside every generalized county polygon, and seven sit on ambiguous county boundaries. Thirteen profiles have a conflict between their reported state and coordinate-derived county state; both observations remain visible.
