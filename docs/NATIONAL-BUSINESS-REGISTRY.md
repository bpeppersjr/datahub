...
The verifier hashes every artifact, parses every record, checks unique IDs and relationship endpoints, requires assertion provenance and export policy, and reconciles ZIP and manifest counts. For compatible publishers 1.2.0 through 1.7.0 it also requires exactly 100 ZIP2 match-profile partitions, validates their links back to provisional entities and their provenance hashes, and requires exactly one profile per provisional physical site. It rejects excluded Connecticut, Colorado, Oregon, Iowa, or New York fields, any site/relationship inference from those registry addresses, loss of the New York OPEN-NY policy, unsupported business-completeness claims, and any USPS denominator without a checksummed governed dependency, exact scoped semantics, conservative deliverability flags, and inherited distribution policy.
...
The independently verified publisher-1.7 release `national-business-registry-20260831-075326227Z-b35a2bcb` contains 16,745,957 governed source rows, including 4,275,497 New York active-extract rows, 347,200 Iowa active-entity rows, and 559,498 Oregon principal-place rows for 559,490 active registrations. It publishes 11,617,415 organizations, 116,332 brands, 6,161,280 provisional physical sites, 6,161,280 provisional establishments, one service, 124,702,659 assertions, 8,601,934 relationships, and exactly 6,161,280 location match profiles across 399 verified artifacts totaling 7,841,630,022 bytes.

Its 45,406-row ZIP union has record-level source contributions in 45,160 ZIPs. New York adds 4,275,497 organizations and 352,234 eligible reported-location/ZIP contributions across 8,653 source ZIPs. Iowa adds 347,200 organizations, 334,176 eligible home-office/ZIP contributions, and 330,664 source-geocoded organization assertions across 9,901 source ZIPs. Oregon adds 443,158 legal-entity registrations as organizations and 116,332 assumed-name registrations as brands, with 559,141 eligible registration/ZIP contributions across 9,177 source ZIPs. New York, Iowa, Oregon, Connecticut, and Colorado state-registry addresses create no physical sites, establishments, relationships, or location profiles. The verified release remains explicitly `published-partial`, and `authoritative_current_usps_zip_denominator` remains `null`.

This 1.7 release supersedes the verified 1.6 registry. Its 100 source-preserving ZIP2 match-profile artifacts and all 6,161,280 physical-site/profile records are unchanged in cardinality; only governed organization/assertion/ZIP evidence and dependency lineage expand. The USPS connector and optional registry integration are implemented, but this current release still omits USPS evidence until an operator truthfully selects an authorized use basis and publishes a local governed USPS source release.
