...
The independently verified publisher-2.3 release `national-business-registry-20260901-042448477Z-52767557` contains 33,509,551 governed source rows. It publishes 18,841,436 organizations, 116,332 brands, 7,753,736 provisional physical sites, 7,753,736 provisional establishments, one service, 186,999,156 assertions, 11,153,514 relationships, and exactly 7,753,736 location match profiles across 523 checksummed artifacts totaling 11,530,247,653 bytes.

Its 48,142-row ZIP union has record-level source contributions in 47,939 rows. NYC DCWP adds 31,163 licensed sites and Business Unique ID organizations from 35,245 selected license rows; 34,397 rows are accepted and 848 are quarantined across 665 business groups. Of the NYC sites, 26,532 have source coordinates and 28,034 report an NYC borough. Chicago adds 42,864 licensed sites and 35,694 account organizations from 53,863 active-license source rows; 52,885 license rows are accepted and 978 are quarantined across 956 site groups. Texas adds 885,097 accepted permit outlets and 700,705 taxpayer organizations from 885,278 source rows; Los Angeles contributes 633,332 accepted location accounts, including 566,943 with source coordinates. The organization-only state layers remain unchanged and create no physical sites or relationships. The release remains explicitly `published-partial`, and `authoritative_current_usps_zip_denominator` remains `null`; a source-reported five-digit value is not represented as a current USPS assignment.

This 2.3 release supersedes the verified 2.2 registry. Its 100 source-preserving ZIP2 match-profile artifacts now include grouped NYC DCWP Active Premises-license sites without weakening source identity, temporal qualifiers, license-only active semantics, address quarantine, or the local-review-only policy. The USPS connector and optional registry integration are implemented, but this current release still omits USPS evidence until an operator truthfully selects an authorized use basis and publishes a local governed USPS source release.
