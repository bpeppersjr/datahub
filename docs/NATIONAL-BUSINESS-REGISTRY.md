...
The national business registry publisher converts governed source records into reusable canonical entities, field assertions, relationships, and ZIP coverage. Current releases combine the verified USDA SNAP current-retailer snapshot, CMS NPPES monthly organization-provider layer, FDIC BankFind active-institution/current-U.S.-location snapshot, NCUA final-quarterly federally insured credit-union layer, USDA FSIS active MPI establishment layer, EPA ECHO source-designated active regulated-facility layer, FMCSA active U.S. Company Census principal-office layer, IRS EO BMF current exempt-organization layer, Connecticut Secretary-of-the-State active Business Registry layer, Colorado Department-of-State Good Standing/Delinquent Business Entities layer, Oregon Secretary-of-State Active Businesses registration layer, and Iowa Secretary-of-State Active Iowa Business Entities layer. It is an operational foundation, not a claim that every U.S. business has been collected.
...
The verifier hashes every artifact, parses every record, checks unique IDs and relationship endpoints, requires assertion provenance and export policy, and reconciles ZIP and manifest counts. For compatible publishers 1.2.0 through 1.6.0 it also requires exactly 100 ZIP2 match-profile partitions, validates their links back to provisional entities and their provenance hashes, and requires exactly one profile per provisional physical site. It rejects excluded Connecticut, Colorado, Oregon, or Iowa fields, any site/relationship inference from those registry addresses, unsupported business-completeness claims, and any USPS denominator without a checksummed governed dependency, exact scoped semantics, conservative deliverability flags, and inherited distribution policy.
...
The independently verified publisher-1.6 release `national-business-registry-20260831-054124535Z-107116a8` contains 12,470,460 governed source rows, including 347,200 Iowa active-entity rows and 559,498 Oregon principal-place rows for 559,490 active registrations. It publishes 7,341,918 organizations, 116,332 brands, 6,161,280 provisional physical sites, 6,161,280 provisional establishments, one service, 102,620,706 assertions, 8,601,934 relationships, and exactly 6,161,280 location match profiles across 367 verified artifacts totaling 6,881,270,205 bytes.

Its 44,870-row ZIP union has record-level source contributions in 44,619 ZIPs. Iowa adds 347,200 organizations, 334,176 eligible home-office/ZIP contributions, and 330,664 source-geocoded organization assertions across 9,901 source ZIPs. Oregon adds 443,158 legal-entity registrations as organizations and 116,332 assumed-name registrations as brands, with 559,141 eligible registration/ZIP contributions across 9,177 source ZIPs. Iowa, Oregon, Connecticut, and Colorado state-registry addresses create no physical sites, establishments, relationships, or location profiles. The verified release remains explicitly `published-partial`, and `authoritative_current_usps_zip_denominator` remains `null`.

This 1.5 release supersedes the verified 1.4 registry. Its 100 source-preserving ZIP2 match-profile artifacts and all 6,161,280 physical-site/profile records are unchanged in cardinality; only governed organization/brand/assertion/ZIP evidence and dependency lineage expand. The USPS connector and optional registry integration are implemented, but this current release still omits USPS evidence until an operator truthfully selects an authorized use basis and publishes a local governed USPS source release.
