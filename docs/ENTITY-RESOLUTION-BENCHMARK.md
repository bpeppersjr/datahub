...
The independently verified sample `business-entity-resolution-benchmark-sample-20260831-192646559Z-69009635` is tied to resolution release `business-entity-resolution-20260831-192344975Z-489cf120` and registry release `national-business-registry-20260831-155144265Z-ba303284`. It sampled 425 candidates from each of these enumerated universes:
...
The 1,275-row packet contains 2,544 unique source-preserving profiles across three verified artifacts totaling 831,408 bytes. Its label template has 0 submitted labels, so both the precision gate and export authorization are correctly false.
