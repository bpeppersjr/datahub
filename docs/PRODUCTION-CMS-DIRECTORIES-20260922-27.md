...
- Local immutable plan: `data/reconciliations/production-plans/production-cms-directories-20260922-27.json`
- Exact confirmation SHA-256: `2007cfeb9e1d998149017c5d4292ba620d4e319fce6801fa95db38cd2eb7de38`
...
```powershell
npm run reconciliation:production:preflight -- --run-id production-cms-directories-20260922-27 --expected-plan-sha256 2007cfeb9e1d998149017c5d4292ba620d4e319fce6801fa95db38cd2eb7de38
```
