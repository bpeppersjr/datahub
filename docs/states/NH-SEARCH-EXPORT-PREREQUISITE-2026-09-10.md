...
The subsequent [current visible-result contract review](NH-VISIBLE-RESULT-CONTRACT-2026-09-10.md) verified the public name/link/address rendering structure and shipping-field origin without submitting another search or retrying CSV export.
